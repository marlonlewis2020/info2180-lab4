...
<?php
$check = false;
$query = strtolower(filter_input(INPUT_GET, 'query', FILTER_SANITIZE_STRING));?>
<!-- <#?php echo "this: ",$_GET['query']; ?> -->
<?php foreach($superheroes as $superhero):?>
    <?php if ($query == strtolower($superhero['alias']) || $query == strtolower($superhero['name'])) :?>
        <?php $check = true;?>
